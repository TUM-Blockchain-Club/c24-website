export const faqItems = [
  ...
  {
    question:
      "Can I still receive the grant if I can only attend one day of the conference?",
    answer:
      "No, attendance on both days of the conference is mandatory to qualify for the reimbursement.",
  },
  {
    question:
