...
const Manifesto = () => {
  return (
    <section className="w-full flex flex-col gap-12 px-6 lg:px-0">
      ...
      <div className="w-full flex justify-center">
        <Text as={"p"} className="text-sm max-w-[42rem]">
          ...
          technologies, projects, and legal landscapes in web3. This year, with
          its own dedicated track, we are placing particular emphasis on
          ...
          and information integrity, where ecosystem lock-ins are the norm, and
          true privacy is virtually non-existent in consumer products, web3
          isn't just a trend - it's a lifeline.
          <br />
          <br />
          Munich, home to Germany's largest technical university and a hotbed of
          innovation, sets the stage for this conference. Here, amidst the blend
